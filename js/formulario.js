...
formulario.addEventListener('submit', (e) =>{
	...
	if (campos.usuario && campos.nombre && campos.password && campos.correo && campos.telefono && terminos.checked) {
		...
		document.getElementById('formulario_mesaje-exito').classList.add('formulario_mesaje-exito-activo');
		setTimeout(() =>{
			document.getElementById('formulario_mesaje-exito').classList.remove('formulario_mesaje-exito-activo');
		}, 5000);
